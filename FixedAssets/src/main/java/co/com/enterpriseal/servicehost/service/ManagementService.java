...
import co.com.enterpriseal.businesslayer.business.AreaBusiness;
import co.com.enterpriseal.businesslayer.business.FixedAssetsBusiness;
import co.com.enterpriseal.businesslayer.business.PersonBusiness;
...
public class ManagementService {
    ...
    private final FixedAssetsBusiness assetsBusiness;
    ...
    public ManagementService(){
        ...
        assetsBusiness = new FixedAssetsBusiness();
    }
    ...
    public ResponseEntity insertArea(@RequestBody AreaModel pAreaModel) {
        ...
        try {
            ...
            headers.set("myResponse", "Ocurrio un error al procesar la consulta. Error: " + ex.getMessage());
            responseEntity = new ResponseEntity<>(headers, HttpStatus.INTERNAL_SERVER_ERROR); // 500
            Logger.writeError(ex.getMessage(), 0, "ManagementService", "insertArea");
        } catch (Exception ex) {
            headers.set("myResponse", "Ocurrio un error al procesar la consulta. Error: " + ex.getMessage());
            responseEntity = new ResponseEntity<>(headers, HttpStatus.INTERNAL_SERVER_ERROR); // 500
            Logger.writeError(ex.getMessage(), 0, "ManagementService", "insertArea");
